<<<<<<< HEAD
/* dashboard_js.js - final clean implementation
   - fetches published Google Sheets CSV
   - parses CSV (handles quoted fields)
   - caches results in localStorage (TTL)
   - dispatches procasef:communes:updated and procasef:kpis:loaded
*/
(function(){
  ...
  function handleParsedRows(rows){ var normalized=rows.map(function(r){ var o={}; for(var k in r) o[norm(k)]=r[k]; o.commune=o.commune||''; o.region=o.region||''; o.collected=Number(o.collected)||0; o.surveyed=Number(o.surveyed)||0; o.validated=Number(o.validated)||0; o.rejected=Number(o.rejected)||0; return o; });
    window.dispatchEvent(new CustomEvent('procasef:communes:updated',{detail:{data:normalized}}));
    var sum=function(k){ return normalized.reduce(function(s,r){ return s + (Number(r[k])||0); },0); };
    var kpis={ total_parcels:sum('collected'), surveyed:sum('surveyed'), validated:sum('validated'), rejected:sum('rejected') };
    window.dispatchEvent(new CustomEvent('procasef:kpis:loaded',{detail:{kpis:kpis}})); }
